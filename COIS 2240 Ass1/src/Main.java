...
public class Main {
    ...
    public static void main(String[] args) {
        int count = 0, endValue = 0, i = 0, n = 0, p = 0;
        String number;
        ...
        try{
            endValue = Integer.parseInt(number);
        } catch(NumberFormatException e){}

        if (endValue <= 0){
            System.out.print("Cannot proceed without a number greater than 0. Goodbye");
            System.exit(0);
        }
        ...
        System.out.print("Time elapsed is: " + timeElapsedRec + " nanoseconds. ");
        ...
        System.out.print("Time elapsed is: " + timeElapsedIte + " nanoseconds. ");
    }
